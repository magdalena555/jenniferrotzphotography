...
function theme_setup() {
	...
	*  sizes with add_image_size. */
	...
	add_image_size('logo', 400, 200, false);
	add_image_size('mystory', 1080, 1290, true);
	add_image_size('large-square', 450, 300, true);
	add_image_size('portfolio-page-thumbnail', 600, 1100, true);
	add_image_size('blog-page', 600, 1100, true);
	add_image_size('portfolio-popout', 1600, 1000, true);
...
function hackeryou_scripts() {
  ...
  // magnific-popup
  wp_enqueue_script( 'magnific-popup-js-js', get_template_directory_uri() . "/js/magnific-popup/jquery.magnific-popup.js", array( 'jquery' ), '1.5.9', false );
